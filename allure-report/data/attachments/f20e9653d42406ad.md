...
- Name: From Layouts Page >> input fields
- Location: C:\Users\Ajij.Shekh\OneDrive - ENCORA\Desktop\GitRepo\pw-practice-app\tests\uiComponent.spec.ts:20:9
...
Call log:
  - waiting for getByText('Forms')
    ...
    at C:\Users\Ajij.Shekh\OneDrive - ENCORA\Desktop\GitRepo\pw-practice-app\tests\uiComponent.spec.ts:16:39
```
...
>  16 |         await page.getByText('Forms').click()
  ...
  108 |
  109 |     page.getByRole("tooltip") // if you have a role tooltip created
  110 |     const tooltip = await page.locator('nb-tooltip').textContent()
  111 |     expect(tooltip).toEqual('This is a tooltip')
  112 | })
  113 |
  114 | test ('Dialog box', async({page}) => {
  115 |     await page.getByText('Tables & Data').click()
  116 |     await page.getByText('Smart Table').click()
```